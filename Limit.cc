...
local L_8_ = L_7_:NewSection("Limit.cc")
L_8_:NewButton(
    "Silent Aim",
...
local L_12_ = L_11_:NewSection("Limit.cc")
L_12_:NewButton(
    "Anti-Lock",
    "Key is Z.",
    function()
...
local L_14_ = L_13_:NewSection("Limit.cc")
L_14_:NewKeybind(
    "Keybind Gui Toggle",
    "h",
    Enum.KeyCode.V,
...
local L_19_ = L_17_:NewSection("Limit.cc")
L_19_:NewToggle(
    "ESP",
    "ESP",
    function(L_201_arg0)
